...
const AuthLayout = ({ children }) => {
  return (
    <div className="flex user-select-none">
      ...
      <div className = "hidden md:block h-screen w-[40vw] bg-violet-50 bg-auth-bg-img bg-cover bg-no-repeat bg-center overflow-hidden p-8 relative">
        ...
        <img
            src={CARD_2}
            alt="Decorative"
            className="w-64 lg:w-[90%] absolute bottom-10 rounded-3xl shadow-lg shadow-blue-400/15"
        />
      </div>
    </div>
  );
